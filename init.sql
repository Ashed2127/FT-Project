...
-- Sample Food Data
INSERT INTO food (food_name, food_price, food_discount, food_type, food_category, food_src) VALUES
...
-- Language Status
CREATE TABLE IF NOT EXISTS languagestatus (
  lang_id INT(11) PRIMARY KEY AUTO_INCREMENT,
  langstatus INT CHECK (langstatus IN (0, 1))
) ENGINE=InnoDB;

INSERT IGNORE INTO languagestatus (lang_id, langstatus) VALUES (1, 0);
